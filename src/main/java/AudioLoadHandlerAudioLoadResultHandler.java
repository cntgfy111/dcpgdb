...
public class AudioLoadHandlerAudioLoadResultHandler implements AudioLoadResultHandler {

    private final SlashCommandInteraction interaction;

    AudioLoadHandlerAudioLoadResultHandler(SlashCommandInteraction interaction){
